...
class Product(unittest.TestCase):
    ...
    def test_buyDay(self,value):
        ...
        WebDriverWait(self.driver, 40).until(EC.visibility_of_element_located((By.NAME,'恭喜您，成功购买天天牛'+value+'.00元')))
    ...
    def test_buyProduct(self,value):
        self.driver.find_elements_by_class_name('android.widget.EditText').send_keys(value)
        self.driver.find_element_by_name('立即购买').click()
        WebDriverWait(self.driver, 40).until(EC.visibility_of_element_located((By.NAME,'恭喜您，成功购买'+value+'.00元')))
